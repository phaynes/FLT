...
import FLTMethodology.Probes.PrePsiWindowSteps
...
theorem addSubMap_eval_sym2x_affine
  ...
  funext i
  fin_cases i <;>
    simp [WeierstrassCurve.Affine.Point.sym2x, WeierstrassCurve.addSubMap,
      kummerBiquadratic, kummerBiquadraticMiddleHomogeneous] <;>
    ring
...
theorem addSubMap_sym2x_self_projective
  ...
  cases Q with
  | zero =>
      simpa [WeierstrassCurve.Affine.Point.sym2x,
        WeierstrassCurve.Affine.Point.xRep] using
        (projectivelyEquivalent3_infinity hrel)
  | some x₂ y₂ h₂ =>
      simpa [WeierstrassCurve.Affine.Point.sym2x,
        WeierstrassCurve.Affine.Point.xRep] using
        (projectivelyEquivalent3_affine hrel)
...
theorem addSubMap_sym2x_zero_exact
  ...
  · change (fun i ↦ (E.addSubMap i).eval
    ...
    funext i
    fin_cases i <;>
      simp [WeierstrassCurve.addSubMap, WeierstrassCurve.Affine.Point.sym2x,
        WeierstrassCurve.Affine.Point.xRep]
  · funext i
    fin_cases i <;>
      simp [WeierstrassCurve.addSubMap, WeierstrassCurve.Affine.Point.sym2x,
        WeierstrassCurve.Affine.Point.xRep] <;> ring
