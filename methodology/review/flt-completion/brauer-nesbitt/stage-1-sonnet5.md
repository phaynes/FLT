...
Difficulty: 8  
Required design budget: 3000 seconds; retry budget: 4500 seconds  
...
| flat-cap retry, underscheduled | 1800s | not reported by bridge; ended before cap | not reported; no completion envelope | provider 529 overload / NO VERDICT |
| second flat-cap process | 1800s | not reported by bridge; cancelled before cap | not reported; no completion envelope | cancelled when difficulty timeout contract superseded flat caps |
| scheduled attempt | 3000s | approximately 560s | not reported; no completion envelope | cancelled when producer ladder superseded tri-design |
