...
| `FLT-TATE-UNRAMIFIED` | ACTIVE | Four Galois-action helpers and Tate-curve ellipticity are kernel-clean; nine admissions remain, with the first construction leaf blocked on the analytic j-invariant round-trip and local-field descent |
